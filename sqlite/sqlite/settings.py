...
ROOT_URLCONF = 'sqlite.urls'  # Project name
...
WSGI_APPLICATION = 'sqlite.wsgi.application'  # Project name
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1']  # Add your host here
DEBUG = True  # Set to False in production
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'dbapp', 'static')]  # Updated path to the static directory in dbapp
